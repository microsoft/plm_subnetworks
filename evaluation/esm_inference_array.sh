#!/bin/bash
#
# EVAL (ARRAY): ESM runs via seq_inference_esm2.py driven from a CSV file
#
...
#SBATCH --mem=50G
#SBATCH -J EVAL-esm-array
#SBATCH --array=0-0%8

set -euo pipefail

DEFAULT_CSV="/users/rvinod/data/rvinod/repos/plm_subnetworks/results_figures/esm-seeds.csv"
COMMON_ARGS=(
    --n_passes 10
    --extend_val
)
...
run_task() {
    ...
    PY="python evaluation/seq_inference_esm2.py"
