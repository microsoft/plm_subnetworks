#!/bin/bash
#
# EVAL (ARRAY): CARP runs via seq_inference_carp.py driven from a CSV file
#
...
#SBATCH --mem=50G
#SBATCH -J EVAL-carp-array-fidelity-10-passes
#SBATCH --array=0-0%8

set -euo pipefail

DEFAULT_CSV="/users/rvinod/data/rvinod/repos/plm_subnetworks/results_figures/carp-v3.csv"
COMMON_ARGS=(
    --n_passes 10
    --extend_val
    --overwrite
...
run_task() {
    ...
    PY="python evaluation/seq_inference_carp.py"
