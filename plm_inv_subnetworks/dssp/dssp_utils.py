...
from plm_inv_subnetworks.dataset.constants import DSSP_8, HELIX_SET, STRAND_SET, COIL_SET
from plm_inv_subnetworks.dataset.cath_dataset import get_cath_db
from plm_inv_subnetworks.dataset.data_paths import PDB_CHAIN_DIR
...
if __name__ == "__main__":
    ...
    FASTA_OUTPUT_FILE = "/users/rvinod/data/rvinod/repos/probing-subnetworks/data/dompdb_chain_atom_s20_dssp.fasta"
