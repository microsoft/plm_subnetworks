...
from plm_inv_subnetworks.dataset.data_paths import PDB_DIR, PDB_CHAIN_DIR, RUN_DIR_PREFIX, CATH_S20_DSSP_FASTA
...
import sys
import argparse
from plm_inv_subnetworks.dataset.cath_dataset import CATHDatabase, CATHEntry, CATH_ENTRY_FILEPATH, get_cath_db
from pathlib import Path

from plm_inv_subnetworks.eval.dssp_utils import get_ssp, compute_3_way_dssp_metrics, compute_8_way_dssp_metrics

import torch
from plm_inv_subnetworks.dataset import data_io

# def calculate_ssp_accuracy(directory1, dssp_fasta=CATH_S20_DSSP_FASTA):
